...
public class extractTextFromImageUsingSeleniumAndCucumber {
	...
	public void user_enter_valid_data_on_the_page(DataTable arg1) throws IOException, TesseractException, InterruptedException {
	  //initialize data table
		 ...
		 //locate the picture verification element
		 ...
		 // set 'tessdata' directory path: if you do not set, you will get "invoild memory access" error info.
	...
	public void user_registration_should_be_success() throws InterruptedException {
